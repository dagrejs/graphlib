...
function Graph(opts) {
  this._isDirected = opts ? opts.directed : true;

  this._isMultigraph = opts ? opts.multigraph: false;
...
Graph.prototype.getParent = function(v) {
...
Graph.prototype.setEdge = function(v, w, value, name) {
  ...
  this._edgeAttrs[e] = valueSpecified ? value : this._defaultEdgeLabelFn(v, w, name);
...
Graph.prototype.getEdge = function(v, w, name) {
  var e = (arguments.length === 1
            ? edgeObjToId(this._isDirected, arguments[0])
            : edgeArgsToId(this._isDirected, v, w, name));
  return this._edgeAttrs[e];
};
