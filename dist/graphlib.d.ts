// Type definitions for graphlib 3.0.0
...
export class Graph<GraphLabel = any, NodeLabel = any, EdgeLabel = any> {
   ...
   * Complexity: O(1).
   *
   * @argument labelOrFn - default node label or label factory function.
   * @returns the graph, allowing this to be chained with other functions.
   */
  setDefaultNodeLabel(labelOrFn: NodeLabel | ((v: string) => NodeLabel)): this;
   ...
   * Complexity: O(1).
   *
   * @argument labelOrFn - default edge label or label factory function.
   * @returns the graph, allowing this to be chained with other functions.
   */
  setDefaultEdgeLabel(labelOrFn: EdgeLabel | ((v: string, w: string, name?: string) => EdgeLabel)): this;
