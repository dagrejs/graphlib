...
declare module "@dagrejs/graphlib" {
  ...
  export class Graph<GraphLabel = any, NodeLabel = any, EdgeLabel = any> {
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setParent(v: string, p?: string): Graph<GraphLabel, NodeLabel, EdgeLabel>;
   ...
   */
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    removeNode(name: string): Graph<GraphLabel, NodeLabel, EdgeLabel>;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    removeEdge(edge: Edge): Graph<GraphLabel, NodeLabel, EdgeLabel>;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setGraph(label: GraphLabel): Graph<GraphLabel, NodeLabel, EdgeLabel>;
